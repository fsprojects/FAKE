[<AutoOpen>]
[<System.Obsolete("use Fake.Core.Tracing instead (open Fake.Core and use 'Tracing.')")>]
...
[<System.Obsolete("This method is unsafe, please open Fake.Core and use 'use _ = Trace.traceTarget' to properly finish the target on errors or use traceStartTargetUnsafe if you know what you do")>]
...
[<System.Obsolete("This method is unsafe, please open Fake.Core and use 'use _ = Trace.traceTask' to properly finish the task on errors or use traceStartTaskUnsafe if you know what you do")>]
...
/// (call it with 'use')
[<System.Obsolete("Please open Fake.Core and use 'use _ = Trace.traceTask' to properly finish the task on errors or use traceStartTaskUnsafe if you know what you do")>]
