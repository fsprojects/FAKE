...
[<assembly: AssemblyTitleAttribute("FAKE - F# Make Core Filesystem utilities and globbing support")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FAKE - F# Make Core Filesystem utilities and globbing support"
