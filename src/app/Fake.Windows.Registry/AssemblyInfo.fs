...
[<assembly: AssemblyTitleAttribute("FAKE - F# Make CRUD functionality for Windows registry")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FAKE - F# Make CRUD functionality for Windows registry"
