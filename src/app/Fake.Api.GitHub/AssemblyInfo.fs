...
[<assembly: AssemblyTitleAttribute("FAKE - F# Make GitHub Client API Support via Octokit")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FAKE - F# Make GitHub Client API Support via Octokit"
