...
[<assembly: AssemblyTitleAttribute("FAKE - F# Make Core commandline parsing support via docopt like syntax")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FAKE - F# Make Core commandline parsing support via docopt like syntax"
