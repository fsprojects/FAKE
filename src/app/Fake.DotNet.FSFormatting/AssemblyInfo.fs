...
[<assembly: AssemblyTitleAttribute("FAKE - F# Make Running fsformatting.exe and generating documentation")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FAKE - F# Make Running fsformatting.exe and generating documentation"
