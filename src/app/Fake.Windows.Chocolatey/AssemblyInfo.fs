...
[<assembly: AssemblyTitleAttribute("FAKE - F# Make Running and packaging with Chocolatey")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FAKE - F# Make Running and packaging with Chocolatey"
