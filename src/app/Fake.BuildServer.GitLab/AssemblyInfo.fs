...
[<assembly: AssemblyTitleAttribute("FAKE - F# Make Integration into GitLab-CI buildserver")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FAKE - F# Make Integration into GitLab-CI buildserver"
