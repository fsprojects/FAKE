...
[<assembly: AssemblyTitleAttribute("FAKE - F# Make Integration into Travis buildserver")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FAKE - F# Make Integration into Travis buildserver"
