...
*)
    ...
    let teamCityBlock name description =
        sendOpenBlock name description
    ...
    let sendTeamCityImportData typ file = sendToTeamCity2 "##teamcity[importData type='%s' file='%s']" typ file

    /// Sends an NUnit results filename to TeamCity
    let sendTeamCityNUnitImport path = sendTeamCityImportData "nunit" path

    /// Sends an FXCop results filename to TeamCity
    let sendTeamCityFXCopImport path = sendTeamCityImportData "FxCop" path

    /// Sends an JUnit Ant task results filename to TeamCity
    let sendTeamCityJUnitImport path = sendTeamCityImportData "junit" path

    /// Sends an Maven Surefire results filename to TeamCity
    let sendTeamCitySurefireImport path = sendTeamCityImportData "surefire" path

    /// Sends an MSTest results filename to TeamCity
    let sendTeamCityMSTestImport path = sendTeamCityImportData "mstest" path

    /// Sends an Google Test results filename to TeamCity
    let sendTeamCityGTestImport path = sendTeamCityImportData "gtest" path
