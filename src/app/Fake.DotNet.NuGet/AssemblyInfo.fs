...
[<assembly: AssemblyTitleAttribute("FAKE - F# Make Running NuGet Client and interacting with NuGet Feeds")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FAKE - F# Make Running NuGet Client and interacting with NuGet Feeds"
