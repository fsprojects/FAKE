...
[<assembly: AssemblyTitleAttribute("FAKE - F# Make Integration into TeamFoundation buildserver")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FAKE - F# Make Integration into TeamFoundation buildserver"
