...
[<System.Obsolete("Please open an issue and tell us why you need it! (FAKE0002 - no longer supported)")>]
let RunParameterTargetOrDefault parameterName defaultTarget =
    getBuildParamOrDefault parameterName defaultTarget |> Run
...
let RunTargetOrDefault defaultTarget =
    getBuildParamOrDefault "target" defaultTarget |> Run
