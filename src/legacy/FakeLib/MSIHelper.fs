...
let Install setParams setup =
    ...
    let args =
        sprintf "%s /l* %s /i %s" (if parameters.Silent then "/qn" else "/qb") parameters.LogFile setup
...
let Uninstall setParams setup =
    ...
    let args =
        sprintf "%s /l* %s /x %s" (if parameters.Silent then "/qn" else "/qb") parameters.LogFile setup
