...
[<System.Obsolete("This API is obsolete. There is no alternative in FAKE 5 yet. You can help by porting this module.")>]
let gacutilToolPath = !!(sdkBasePath + "/**/gacutil.exe") |> getNewestTool
...
[<System.Obsolete("This API is obsolete. There is no alternative in FAKE 5 yet. You can help by porting this module.")>]
let mutable GACUtil = if isMono then "gacutil" else gacutilToolPath
...
let GAC setParams command =
    ...
    if not ok then
        failwithf "gacutil reported errors."
