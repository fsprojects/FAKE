...
let reference =
    root @@ "..\..\..\..\packages\FluentMigrator\lib\40\FluentMigrator.dll"

let assembly = root @@ "sample.migrations.dll"
let migrations = [ root @@ "CatsDatabase.cs" ]

let connection =
    ConnectionString(
        @"Data Source=(localdb)\MSSQLLocalDb;Initial Catalog=FAKE.DB;Integrated Security=True",
        SqlServer(V2014)
    )
