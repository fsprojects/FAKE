          ...
          <| fun _ ->
              ...
              try
                  ...
                  Expect.equal
                      ...
                      { Declaration.Empty with File = scriptFile; Line = 36 }
                  ...
                  Expect.equal
                      ...
                      { Declaration.Empty with File = scriptFile; Line = 38 }
                      testTarget.Declaration

                  Expect.equal
                      "Expected correct hard dependencies of 'TestTarget'"
                      [ { Name = "Start"
                          Declaration = { Declaration.Empty with File = scriptFile; Line = 45 } } ]
